...
class EditShopProductScreen extends StatefulWidget {
  final String keyP;
  final Products product;
  final String service;
  final String merchantKey;
  const EditShopProductScreen(
      {Key key, this.keyP, this.service, this.product, this.merchantKey})
      : super(key: key);
  @override
  _AddShopProductState createState() => _AddShopProductState();
}

class _AddShopProductState extends State<EditShopProductScreen> {
  ...
  void initState() {
    ...
    keyP = widget.keyP;
    passedUri = shopProduct.image;
    _productCategory = widget.product.category;
    _featuredImageString = widget.product.image;
    //_featuredImageString = shopProduct.image;
    servicenameList = _serviceHealth[widget.product.category];
        ...
        child: Center(
          child: GestureDetector(
            ...
            child: CircleAvatar(
              ...
              child: _featuredImageString != null
                  ? ClipRRect(
